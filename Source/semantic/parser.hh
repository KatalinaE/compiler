...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    union union_type
    {
      ...
      // declarations
      char dummy5[sizeof (Declarations*)];
      ...
      // statment
      char dummy11[sizeof (Statment*)];

      // statments
      char dummy12[sizeof (Statments*)];
...
#endif
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, Arguments*&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const Arguments*& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
#endif
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, Declarations*&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const Declarations*& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
#endif
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, Extends*&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const Extends*& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
#endif
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, Statment*&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const Statment*& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
#endif
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, Statments*&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const Statments*& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
switch (yytype)
    {
      ...
      case 50: // arguments
        value.template destroy< Arguments* > ();
        break;
      ...
      case 63: // declarations
        value.template destroy< Declarations* > ();
        break;
      ...
      case 64: // extends
        value.template destroy< Extends* > ();
        break;
      ...
      case 52: // statment
        value.template destroy< Statment* > ();
        break;

      case 53: // statments
        value.template destroy< Statments* > ();
        break;
    ...
    struct symbol_type : basic_symbol<by_type>
    {
      ...
      {
        YY_ASSERT (tok == token::TOK_END || tok == token::TOK_ASSIGN || tok == token::TOK_MINUS || tok == token::TOK_PLUS || tok == token::TOK_STAR || tok == token::TOK_DIV || tok == token::TOK_MOD || tok == token::TOK_LESS || tok == token::TOK_MORE || tok == token::TOK_EQ || tok == token::TOK_AND || tok == token::TOK_OR || tok == token::TOK_NOT || tok == token::TOK_LPAREN || tok == token::TOK_RPAREN || tok == token::TOK_LEFTSCOPE || tok == token::TOK_RIGHTSCOPE || tok == token::TOK_SEMICOLON || tok == token::TOK_LEFTADDRESS || tok == token::TOK_RIGHTADDRESS || tok == token::TOK_FIELD || tok == token::TOK_INT || tok == token::TOK_BOOLEAN || tok == token::TOK_VOID || tok == token::TOK_NEW || tok == token::TOK_THIS || tok == token::TOK_CLASS || tok == token::TOK_EXTENDS || tok == token::TOK_PUBLIC || tok == token::TOK_ELSE || tok == token::TOK_ASSERT || tok == token::TOK_STATIC || tok == token::TOK_MAIN || tok == token::TOK_RETURN || tok == token::TOK_PRINT || tok == token::TOK_IF || tok == token::TOK_WHILE || tok == 297 || tok == 298);
      }
#else
    ...
    // Implementation of make_symbol for each symbol type.
      ...
      static
      symbol_type
      make_LEFTADDRESS (location_type l)
      {
        return symbol_type (token::TOK_LEFTADDRESS, std::move (l));
      }
#else
      static
      symbol_type
      make_LEFTADDRESS (const location_type& l)
      {
        return symbol_type (token::TOK_LEFTADDRESS, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
      symbol_type
      make_RIGHTADDRESS (location_type l)
      {
        return symbol_type (token::TOK_RIGHTADDRESS, std::move (l));
      }
#else
      static
      symbol_type
      make_RIGHTADDRESS (const location_type& l)
      {
        return symbol_type (token::TOK_RIGHTADDRESS, l);
      }
#endif
#if 201103L <= YY_CPLUSPLUS
      static
    ...
    , location (std::move (that.location))
  {
    switch (this->type_get ())
    {
      case 49: // arguments_any
      case 50: // arguments
        value.move< Arguments* > (std::move (that.value));
        break;
      ...
      case 63: // declarations
        value.move< Declarations* > (std::move (that.value));
        break;
      ...
      case 64: // extends
        value.move< Extends* > (std::move (that.value));
        break;
      ...
      case 51: // local_var_declaration
      case 52: // statment
        value.move< Statment* > (std::move (that.value));
        break;

      case 53: // statments
        value.move< Statments* > (std::move (that.value));
        break;
    ...
    , location (that.location)
  {
    switch (this->type_get ())
    {
      case 49: // arguments_any
      case 50: // arguments
        value.copy< Arguments* > (YY_MOVE (that.value));
        break;
      ...
      case 63: // declarations
        value.copy< Declarations* > (YY_MOVE (that.value));
        break;
      ...
      case 64: // extends
        value.copy< Extends* > (YY_MOVE (that.value));
        break;
      ...
      case 51: // local_var_declaration
      case 52: // statment
        value.copy< Statment* > (YY_MOVE (that.value));
        break;

      case 53: // statments
        value.copy< Statments* > (YY_MOVE (that.value));
        break;
  ...
  parser::basic_symbol<Base>::move (basic_symbol& s)
  {
    ...
    switch (this->type_get ())
    {
      case 49: // arguments_any
      case 50: // arguments
        value.move< Arguments* > (YY_MOVE (s.value));
        break;
      ...
      case 63: // declarations
        value.move< Declarations* > (YY_MOVE (s.value));
        break;
      ...
      case 64: // extends
        value.move< Extends* > (YY_MOVE (s.value));
        break;
      ...
      case 51: // local_var_declaration
      case 52: // statment
        value.move< Statment* > (YY_MOVE (s.value));
        break;

      case 53: // statments
        value.move< Statments* > (YY_MOVE (s.value));
        break;
